      ...
      <div className="flex justify-between items-center mb-6">
        ...
        {view === 'list' && (
          <button
                        ...
                        className="bg-[#0C4185] hover:opacity-90 text-white px-4 py-2 rounded-xl font-medium flex items-center shadow-lg shadow-blue-900/20 transition-all active:scale-95 text-[12px] sm:text-base"
                    >
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 text-xs text-slate-500">
                                ...
                                {campaign.targeting?.country && campaign.targeting.country !== 'Worldwide' && (
                                    <span className="bg-blue-50 text-black px-1.5 rounded text-[10px] font-bold flex items-center">
