...
import { 
    ...
    MessageSquare, ChevronDown, ChevronUp, AlertTriangle, Link2, Search 
} from 'lucide-react';
        ...
        <div>
            ...
            <div className="bg-slate-50 p-3 rounded-xl flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-xs font-bold text-slate-900">iPhone 13 Pro</p>
                        <p className="text-[10px] text-slate-500">Casablanca, Morocco • Now</p>
                    </div>
                </div>
    ...
    return (
        <div className="space-y-4">
             <div className="bg-indigo-50 p-4 rounded-xl flex items-start gap-3">
                <MessageSquare className="w-5 h-5 text-indigo-600 mt-1 rtl:ml-2" />
                <div>
                    <h4 className="text-sm font-bold text-indigo-900">Need direct help?</h4>
                    <p className="text-xs text-indigo-700 mt-1">Our support team is available 24/7 for urgent issues.</p>
                    <button className="mt-2 text-xs font-bold bg-white text-indigo-600 px-3 py-1.5 rounded shadow-sm border border-indigo-100">Start Chat</button>
                </div>
             </div>
    ...
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in relative">
      ...
      <div className="text-center pb-6 border-b border-slate-100">
         <div className="relative inline-block">
            <img src={user.avatarUrl} alt="Avatar" className="w-24 h-24 rounded-full mb-4 border-4 border-white shadow-lg object-cover" />
            <div className="absolute bottom-4 right-0 bg-green-500 border-2 border-white w-5 h-5 rounded-full"></div>
         </div>
      ...
      <div className="bg-gradient-to-r from-pink-500 to-rose-500 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
         <div className="relative z-10 flex justify-between items-center">
            <div>
                ...
                <button className="bg-white text-rose-600 text-xs font-bold px-4 py-2 rounded-lg shadow hover:bg-pink-50 transition-colors">
                    {t('prof.copy_link')}
                </button>
            </div>
