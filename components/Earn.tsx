...
import { Heart, UserPlus, Eye, ExternalLink, Flame, X, AlertCircle, Globe, MapPin, Search, ChevronDown, Check, Coins } from 'lucide-react';
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <header className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        {/* Daily Streak Badge */}
        <div className="bg-orange-50 border border-orange-100 px-4 py-2 rounded-xl flex items-center self-start sm:self-auto">
            <div className="bg-orange-100 p-1.5 rounded-full ltr:mr-3 rtl:ml-3">
                <Flame className="w-5 h-5 text-orange-500 fill-orange-500" />
            </div>
            <div>
                <p className="text-xs text-orange-800 font-bold uppercase tracking-wider">{t('earn.streak')}</p>
                <p className="text-lg font-bold text-orange-600 leading-none">{streak} {t('earn.days')}</p>
            </div>
        </div>
      </header>
            ...
            >
              ...
              <div className="flex items-center w-full sm:w-auto gap-2">
                  ...
                  <button
                    ...
                    className={`flex-1 sm:flex-none px-6 py-2.5 rounded-xl font-medium flex items-center justify-center space-x-2 rtl:space-x-reverse transition-all ${
                      processing === task.id
